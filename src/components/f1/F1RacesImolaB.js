...
export default function F1RacesMexicoB () {
  return (
    <div className="page-content">
        ...
        <F1RaceResult teamBackground="rgba(249, 21, 54, 0.2)" teamImage="/ferrari.png" constructorName="Ferrari" driverName="Cheers" driverFlag="/de.png" driverInterval="44:23.363" driverFastLap="1:17.838" driverGrid="4" driverPosition="1" driverPoints="30" arrow="fa-solid fa-angle-up" lapColor="#6a3d9e"/>
        ...
        <F1RaceResult teamBackground="rgba(34, 147, 209, 0.2)" teamImage="/alpine.png" constructorName="Alpine" driverName="Vade" driverFlag="/se.png" driverInterval="+23.35" driverFastLap="1:19.402" driverGrid="5" driverPosition="9" driverPoints="2" arrow="fa-solid fa-angle-up" />
