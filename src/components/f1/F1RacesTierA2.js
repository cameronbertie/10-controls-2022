...
export default function F1RacesTierA () {
  ...
  races.push({ id: 4, name: 'Suzuka', date: new Date(2022, 0, 6).getTime(), flag: '/jp.png' })
  races.push({ id: 5, name: 'Hungaroring', date: new Date(2022, 0, 13).getTime(), flag: '/hu.png' })
  races.push({ id: 6, name: 'Spielberg (Sprint)', date: new Date(2022, 0, 20).getTime(), flag: '/at.png' })
  races.push({ id: 7, name: 'Baku', date: new Date(2022, 0, 27).getTime(), flag: '/az.png' })
  races.push({ id: 8, name: 'Shanghai', date: new Date(2022, 1, 3).getTime(), flag: '/cn.png' })
  races.push({ id: 9, name: 'Austin (Sprint)', date: new Date(2022, 1, 10).getTime(), flag: '/us.png' })
  races.push({ id: 10, name: 'Imola', date: new Date(2022, 1, 17).getTime(), flag: '/it.png' })
  races.push({ id: 11, name: 'Singapore', date: new Date(2022, 1, 24).getTime(), flag: '/sg.png' })
  races.push({ id: 12, name: 'Interlagos', date: new Date(2022, 2, 3).getTime(), flag: '/br.png' })
  return (
