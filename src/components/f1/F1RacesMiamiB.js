...
export default function F1RacesHungaroringB () {
  return (
    <div className="page-content">
        ...
        <F1RaceResult teamBackground="rgba(108, 211, 191, 0.2)" teamImage="/mercedes.png" constructorName="Mercedes" driverName="Nydrow" driverFlag="/be.png" driverInterval="+1:00.977" driverFastLap="1:29.652" driverGrid="4" driverPosition="8" driverPoints="5" arrow="fa-solid fa-angle-down" lapColor="#6a3d9e"/>
