...
export default function F1RacesHungaroringB () {
  return (
    <div className="page-content">
        ...
        <F1RaceResult teamBackground="rgba(94, 143, 170, 0.2)" teamImage="/alpha-tauri.png" constructorName="AlphaTauri" driverName="Br0wn" driverFlag="/de.png" driverInterval="+3.854" driverFastLap="1:18.327" driverGrid="2" driverPosition="3" driverPoints="16" arrow="fa-solid fa-angle-up" lapColor="#6a3d9e"/>
