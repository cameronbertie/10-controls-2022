...
export default function F1RacesJeddahA () {
  return (
    <div className="page-content">
        ...
        <F1RaceResult teamBackground="rgba(245, 128, 32, 0.2)" teamImage="/mclaren.png" constructorName="Mclaren" driverName="iM3j3n" driverFlag="/de.png" driverInterval="DNF" driverFastLap="1:30.814" driverGrid="7" driverPosition="11" driverPoints="0" arrow="fa-solid fa-angle-up" lapColor="#6a3d9e"/>
