...
export default function F1RacesJeddahB () {
  return (
    <div className="page-content">
        ...
        <F1RaceResult teamBackground="rgba(201, 45, 75, 0.2)" teamImage="/alfa-romeo.png" constructorName="Alfa Romeo" driverName="Philip" driverFlag="/nl.png" driverInterval="+9.664" driverFastLap="1:22.333" driverGrid="9" driverPosition="5" driverPoints="10" arrow="fa-solid fa-angle-up"/>
        <F1RaceResult teamBackground="rgba(249, 21, 54, 0.2)" teamImage="/ferrari.png" constructorName="Ferrari" driverName="Veixel" driverFlag="/se.png" driverInterval="+10.040" driverFastLap="1:22.837" driverGrid="2" driverPosition="6" driverPoints="9" arrow="fa-solid fa-angle-up"/>
        ...
        <F1RaceResult teamBackground="rgba(245, 128, 32, 0.2)" teamImage="/mclaren.png" constructorName="Mclaren" driverName="C3z4R" driverFlag="/ro.png" driverInterval="+27.108" driverFastLap="1:23.032" driverGrid="" driverPosition="10" driverPoints="1" />
        ...
        <F1RaceResult teamBackground="rgba(108, 211, 191, 0.2)" teamImage="/mercedes.png" constructorName="Alpine" driverName="Aspec" driverFlag="/gb.png" driverInterval="DNF" driverFastLap="" driverGrid="4" driverPosition="-" driverPoints="0" arrow="fa-solid fa-angle-down" />
        </table>
