    ...
    {selectedDivision === 'Tier A' && selectedSeason === 'Season 1'
      ...
      : selectedDivision === 'Tier B' && selectedSeason === 'Season 1'
        ...
        : selectedDivision === 'Tier A' && selectedSeason === 'Season 2'
         ...
         <F1Team teamColor="#B6BABD" teamBackground="rgba(182, 186, 189, 0.2)" teamImage="/haas.png" teamName="Haas" driver1Name="MAX HOUSLEY" driver1Number="8" driver1Flag="/gb.png" driver2Name="KJAERBO" driver2Number="3" driver2Flag="/de.png" />
