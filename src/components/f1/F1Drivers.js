    ...
    {selectedDivision === 'Tier A' && selectedSeason === 'Season 1'
      ...
      : selectedDivision === 'Tier B' && selectedSeason === 'Season 1'
        ...
        : selectedDivision === 'Tier A' && selectedSeason === 'Season 2'
          ...
          <F1Team teamColor="#B6BABD" teamBackground="rgba(182, 186, 189, 0.2)" teamImage="/haas.png" teamName="Haas" driver1Name="Daniel Bodnar" driver1Number="18" driver1Flag="/sk.png" driver2Name="Philip" driver2Number="22" driver2Flag="/nl.png" />
