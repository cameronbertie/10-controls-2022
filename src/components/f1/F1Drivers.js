  ...
  return (
    ...
    {selectedDivision === 'Tier A'
      ...
      : <>
         ...
         <F1Team teamColor="#2293D1" teamBackground="rgba(34, 147, 209, 0.2)" teamImage="/alpine.png" teamName="Alpine" driver1Name="Vade" driver1Number="21" driver1Flag="/se.png" driver2Name="Aspec" driver2Number="37" driver2Flag="/gb.png" />
         ...
         <F1Team teamColor="#358C75" teamBackground="rgba(53, 140, 117, 0.2)" teamImage="/aston-martin.png" teamName="Aston Martin" driver1Name="Hugyme" driver1Number="16" driver1Flag="/gb.png" driver2Name="F1 Gamer" driver2Number="96" driver2Flag="/gb.png" />
         <F1Team teamColor="#37BEDD" teamBackground="rgba(55, 190, 221, 0.2)" teamImage="/williams.png" teamName="Williams" driver1Name="Uklucasw" driver1Number="66" driver1Flag="/gb.png" driver2Name="Cesar2Wizard" driver2Number="98" driver2Flag="/fr.png" />
         ...
         <F1Team teamColor="#B6BABD" teamBackground="rgba(182, 186, 189, 0.2)" teamImage="/haas.png" teamName="Haas" driver1Name="Luc" driver1Number="13" driver1Flag="/nl.png" driver2Name="Jay Azier" driver2Number="2" driver2Flag="/nl.png" />
         </>
        }
    </div>
    <Footer />
