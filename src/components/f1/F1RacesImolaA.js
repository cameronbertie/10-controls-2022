...
export default function F1RacesMiamiA () {
  return (
    <div className="page-content">
        ...
        <F1RaceResult teamBackground="rgba(53, 140, 117, 0.2)" teamImage="/aston-martin.png" constructorName="Aston Martin" driverName="Counterfeit" driverFlag="/gb.png" driverInterval="+50.487" driverFastLap="1:16.992" driverGrid="2" driverPosition="9" driverPoints="3" arrow="fa-solid fa-angle-up" lapColor="#6a3d9e"/>
