...
export default function F1RacesMiamiA () {
  return (
    <div className="page-content">
        ...
        <F1RaceResult teamBackground="rgba(54, 113, 198, 0.2)" teamImage="/red-bull.png" constructorName="Red Bull" driverName="ThomasVink" driverFlag="/nl.png" driverInterval="+0.038" driverFastLap="1:31.849" driverGrid="" driverPosition="2" driverPoints="24" />
