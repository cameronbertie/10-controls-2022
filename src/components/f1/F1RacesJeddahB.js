...
export default function F1RacesJeddahB () {
  return (
    <div className="page-content">
        ...
        <F1RaceResult teamBackground="rgba(108, 211, 191, 0.2)" teamImage="/mercedes.png" constructorName="Mercedes" driverName="Zerotix" driverFlag="/de.png" driverInterval="+31.701" driverFastLap="1:30.769" driverGrid="10" driverPosition="10" driverPoints="2" arrow="fa-solid fa-angle-up" lapColor="#6a3d9e"/>
