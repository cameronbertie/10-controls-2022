...
function F1RaceFormat () {
  ...
  <br></br>
  <p>The top 5 drivers of Tier A will earn a share of the prize-pool, which for Tier A runs as follows, from P1 to P5 respectively: $30, $12.50, $5, $2.50, and $1</p>
  <br></br>
  ...
  <br></br>
  <p>
The prize-pool for Tier B will run as follows, from P1 to P4 respectively: $10, $5, $2.50 and $1.00.</p>
<br></br>
