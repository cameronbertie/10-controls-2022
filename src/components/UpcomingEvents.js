...
export default function UpcomingEvents () {
  return (
    <section className="upcoming-container">
        ...
        <EventBox game="f1 22" gameImage="/f1-white.png" tournamentType="Tier B - Season 1" tournamentName="Silverstone" tournamentDate="August 13th 2022" buttonLink="/f1/register" viewAllLink="/f1/races"/>
</section>
  )
}
