...
export default function UpcomingEvents () {
  return (
    <section className="upcoming-container">
        ...
        <EventBox game="f1 22" gameImage="/f1-white.png" tournamentType="Season 1" tournamentName="Hungaroring" tournamentDate="16/17th September 2022" buttonLink="/f1/register" viewAllLink="/f1/races"/>
</section>
  )
}
