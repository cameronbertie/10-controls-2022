...
export default function UpcomingEvents () {
  return (
    <section className="upcoming-container">
        ...
        <EventBox game="f1 22" gameImage="/f1-white.png" tournamentType="Tier B - Season 1" tournamentName="Monza (Sprint)" tournamentDate="10th September 2022" buttonLink="/f1/register" viewAllLink="/f1/races"/>
</section>
  )
}
