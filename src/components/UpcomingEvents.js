...
export default function UpcomingEvents () {
  return (
    <section className="upcoming-container">
        ...
        <EventBox game="f1 22" gameImage="/f1-white.png" tournamentType="Tier A - Season 1" tournamentName="Zandvoort" tournamentDate="9th September 2022" buttonLink="/f1/register" viewAllLink="/f1/races"/>
</section>
  )
}
