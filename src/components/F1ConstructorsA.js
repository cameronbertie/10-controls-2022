...
export default function F1ConstructorsA () {
  return (
    <div className="drivers-list">
        ...
        <F1ConstructorStanding teamColor="#B6BABD" teamBackground="rgba(182, 186, 189, 0.2)" teamImage="/haas.png" constructorName="Haas" constructorPosition="4" constructorPoints="13" />
